...
(function(a) {
    ...
    function hb(a, b, c) {
        ...
        return (
            f > e && (f -= 7),
            e - 7 > f && (f += 7),
            (d = tb(a).add(f, "d")), { week: Math.ceil(d.dayOfYear() / 7), year: d.year() }
        );
    }
    ...
    function ib(a, b, c, d, e) {
        ...
        return (
            ...
            (g = 7 * (b - 1) + (c - e) + f + 1), { year: g > 0 ? a : a - 1, dayOfYear: g > 0 ? g : D(a - 1) + g }
        );
    }
    ...
    m((tb.fn = k.prototype), {
            ...
            isSame: function(a, b) {
                ...
                return (
                    ...
                    "millisecond" === b ?
                    ((a = tb.isMoment(a) ? a : tb(a)), +this === +a) :
                    ((c = +tb(a)), +this.clone().startOf(b) <= c && c <= +this.clone().endOf(b))
                );
            },
            min: f(
